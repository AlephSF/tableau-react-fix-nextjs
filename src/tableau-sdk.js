...
(function () {
  ...
  var $tab_StringExtensions = (global.tab.StringExtensions = ss.mkType(
    $asm,
    "tab.StringExtensions",
    null,
    null,
    {
      decodeUriComponentCorrectly:
        function StringExtensions$DecodeUriComponentCorrectly(s) {
    ...
    null,
    {
      getUriQueryParameters: function UriExtensions$GetUriQueryParameters(uri) {
        ...
        for (var $t1 = 0; $t1 < paramPairs.length; $t1++) {
          ...
          var key = $tab_StringExtensions.decodeUriComponentCorrectly(
            keyValue[0]
          );
          var values;
          ...
          if (keyValue.length > 1) {
            values.push(
              $tab_StringExtensions.decodeUriComponentCorrectly(keyValue[1])
            );
          }
        }
        return parameters;
    ...
    },
    {
      ...
      getOrigin: function WindowHelper$GetOrigin(window, includePort) {
        return (
          ...
          "//" +
          (includePort ? window.location.host : window.location.hostname)
        );
      },
      ...
      $setDefaultRequestAnimationFrameImpl:
        function WindowHelper$SetDefaultRequestAnimationFrameImpl() {
          var lastTime = 0;
...
(function () {
  ...
  var $tab__ApiObjectRegistry = (global.tab._ApiObjectRegistry = ss.mkType(
    ...
    null,
    {
      registerApiMessageRouter:
        function ApiObjectRegistry$RegisterApiMessageRouter(
          objectCreationFunc
        ) {
      ...
      disposeApiMessageRouter:
        function ApiObjectRegistry$DisposeApiMessageRouter() {
  ...
  var $tab__ApiServerNotification = (global.tab._ApiServerNotification =
    ss.mkType(
      $asm,
  ...
  var $tab__ApiServerResultParser = (global.tab._ApiServerResultParser =
    ss.mkType(
      $asm,
  ...
  var $tab__CollectionImpl = (global.tab._CollectionImpl = ss.mkType(
    ...
    },
    {
      ...
      $verifyUniqueKeyParameter:
        function DoNotUseCollection$VerifyUniqueKeyParameter(key) {
      ...
      $verifyKeyAndItemParameters:
        function DoNotUseCollection$VerifyKeyAndItemParameters(key, item) {
    ...
    },
    {
      ...
      all: function DoNotUseDeferred$All(promisesOrValues) {
        ...
        var resolveOne = function resolveOne(promiseOrValue, index) {
          var promise =
            $tab_$DeferredUtil.$coerceToTrustedPromise(promiseOrValue);
          promise.then(
      ...
      $transitionToFulfilled: function DoNotUseDeferred$TransitionToFulfilled(
        ...
        var completedPromise =
          $tab_$DeferredUtil.$coerceToTrustedPromise(completed);
  ...
  var $tab__Param = (global.tab._Param = ss.mkType(
    ...
    null,
    {
      ...
      verifyStringMaxLength: function Param$VerifyStringMaxLength(
        argumentValue,
        argumentName
      ) {
        if (argumentValue.length > $tab__Param.$maxChars) {
          throw $tab__TableauException.createMaxCharStringArgumentException(
            argumentName,
            $tab__Param.$maxChars
          );
        }
  ...
  var $tab__TableauException = (global.tab._TableauException = ss.mkType(
    ...
    null,
    {
      ...
      createInternalNullArgumentException:
        function TableauException$CreateInternalNullArgumentException(
          argumentName
        ) {
      ...
      createInternalStringArgumentException:
        function TableauException$CreateInternalStringArgumentException(
          argumentName
        ) {
          return $tab__TableauException.createInternalError(
      ...
      createMaxCharStringArgumentException:
        function TableauException$CreateMaxCharStringArgumentException(
          argumentName,
          maxChars
        ) {
          return $tab__TableauException.createInternalError(
      ...
      createInvalidCustomViewName:
        function TableauException$CreateInvalidCustomViewName(customViewName) {
          return $tab__TableauException.create(
      ...
      createInvalidFilterFieldNameOrValue:
        function TableauException$CreateInvalidFilterFieldNameOrValue(
          fieldName
        ) {
          return $tab__TableauException.create(
      ...
      createInvalidDateParameter:
        function TableauException$CreateInvalidDateParameter(paramName) {
          return $tab__TableauException.create(
            "invalidDateParameter",
            "Invalid date parameter: " + paramName
          );
        },
      createNullOrEmptyParameter:
        function TableauException$CreateNullOrEmptyParameter(paramName) {
          return $tab__TableauException.create(
      ...
      createMissingMinMaxSize:
        function TableauException$CreateMissingMinMaxSize() {
          return $tab__TableauException.create(
            "missingMinMaxSize",
      ...
      createInvalidRangeSize:
        function TableauException$CreateInvalidRangeSize() {
          return $tab__TableauException.create(
            "invalidSize",
            "Missing minSize or maxSize for SheetSizeBehavior.RANGE"
          );
      ...
      createInvalidSizeValue:
        function TableauException$CreateInvalidSizeValue() {
          return $tab__TableauException.create(
            "invalidSize",
            "Size value cannot be less than zero"
          );
        },
      createInvalidSheetSizeParam:
        function TableauException$CreateInvalidSheetSizeParam() {
          return $tab__TableauException.create(
            "invalidSize",
            "Invalid sheet size parameter"
          );
        },
      createSizeConflictForExactly:
        function TableauException$CreateSizeConflictForExactly() {
          return $tab__TableauException.create(
            "invalidSize",
      ...
      createInvalidSizeBehaviorOnWorksheet:
        function TableauException$CreateInvalidSizeBehaviorOnWorksheet() {
          return $tab__TableauException.create(
            "invalidSizeBehaviorOnWorksheet",
            "Only SheetSizeBehavior.AUTOMATIC is allowed on Worksheets"
          );
        },
      createNoUrlForHiddenWorksheet:
        function TableauException$CreateNoUrlForHiddenWorksheet() {
          return $tab__TableauException.create(
      ...
      createInvalidAggregationFieldName:
        function TableauException$CreateInvalidAggregationFieldName(fieldName) {
          return $tab__TableauException.create(
            "invalidAggregationFieldName",
            "Invalid aggregation type for field '" + fieldName + "'"
          );
        },
      createInvalidToolbarButtonName:
        function TableauException$CreateInvalidToolbarButtonName(buttonName) {
          return $tab__TableauException.create(
      ...
      createUnsupportedEventName:
        function TableauException$CreateUnsupportedEventName(eventName) {
          return $tab__TableauException.create(
      ...
      createBrowserNotCapable:
        function TableauException$CreateBrowserNotCapable() {
          return $tab__TableauException.create(
            "browserNotCapable",
  ...
  var $tab__Utility = (global.tab._Utility = ss.mkType(
    ...
    null,
    {
      ...
      visibleContentRectInDocumentCoordinates:
        function Utility$VisibleContentRectInDocumentCoordinates(element) {
          var visibleRect =
            $tab__Utility.contentRectInDocumentCoordinates(element);
          for (
            ...
            var overflow =
              $tab__Utility.$getComputedStyle(currentElement).overflow;
            if (
              overflow === "auto" ||
              overflow === "scroll" ||
              overflow === "hidden"
      ...
      contentRectInDocumentCoordinates:
        function Utility$ContentRectInDocumentCoordinates(element) {
  ...
  var $tab_$DoNothingCrossDomainHandler = ss.mkType(
    ...
    {
      add_stateReadyForQuery:
        function DoNothingCrossDomainHandler$add_StateReadyForQuery(value) {
          this.$1$StateReadyForQueryField = ss.delegateCombine(
            this.$1$StateReadyForQueryField,
            value
          );
        },
      remove_stateReadyForQuery:
        function DoNothingCrossDomainHandler$remove_StateReadyForQuery(value) {
      ...
      handleEventNotification:
        function DoNothingCrossDomainHandler$HandleEventNotification(
          eventName,
          parameters
        ) {},
      $silenceTheCompilerWarning:
        function DoNothingCrossDomainHandler$SilenceTheCompilerWarning() {
          this.$1$StateReadyForQueryField(null);
        },
    }
  );
  ...
  var $tab_ApiDashboardObjectType = (global.tab.ApiDashboardObjectType =
    ss.mkEnum(
      $asm,
  ...
  var $tab_ApiEnumConverter = (global.tab.ApiEnumConverter = ss.mkType(
    ...
    null,
    {
      convertDashboardObjectType:
        function ApiEnumConverter$ConvertDashboardObjectType(crossDomainType) {
      ...
      convertFieldAggregation:
        function ApiEnumConverter$ConvertFieldAggregation(crossDomainType) {
          switch (crossDomainType) {
            case "ATTR": {
              return "ATTR";
            }
            ...
            default: {
              throw $tab__TableauException.createInternalError(
                "Unknown ApiCrossDomainFieldAggregationType: " + crossDomainType
              );
            }
          }
        },
      ...
      convertParameterAllowableValuesType:
        function ApiEnumConverter$ConvertParameterAllowableValuesType(
          crossDomainType
        ) {
          switch (crossDomainType) {
            case "all": {
      ...
      convertParameterDataType:
        function ApiEnumConverter$ConvertParameterDataType(crossDomainType) {
          switch (crossDomainType) {
            case "boolean": {
              return "boolean";
            }
  ...
  var $tab_ApiFieldAggregationType = (global.tab.ApiFieldAggregationType =
    ss.mkEnum(
      $asm,
  ...
  var $tab_ApiMenuType = (global.tab.ApiMenuType = ss.mkEnum(
    $asm,
    "tab.ApiMenuType",
    { ubertip: "ubertip" },
    true
  ...
  var $tab_ApiMessageHandler = (global.tab.ApiMessageHandler = ss.mkType(
    ...
    {
      handleEventNotification:
        function ApiMessageHandler$HandleEventNotification(
          eventName,
          eventParameters
        ) {
  ...
  var $tab_ApiParameterAllowableValuesType =
    (global.tab.ApiParameterAllowableValuesType = ss.mkEnum(
      $asm,
  ...
  var $tab_ApiSelectionUpdateType = (global.tab.ApiSelectionUpdateType =
    ss.mkEnum(
      $asm,
  ...
  var $tab_CommandReturnHandler$1 = (global.tab.CommandReturnHandler$1 =
    ss.mkType($asm, "tab.CommandReturnHandler$1", function (T) {
      var $type = ss.registerGenericClassInstance(
        $tab_CommandReturnHandler$1,
        [T],
        function (
        ...
        },
        {
          ...
          get_successCallback:
            function CommandReturnHandler$get_SuccessCallback() {
              return this.$successCallback;
            },
          get_successCallbackTiming:
            function CommandReturnHandler$get_SuccessCallbackTiming() {
  ...
  var $tab_CrossDomainMessager = (global.tab.CrossDomainMessager = ss.mkType(
    ...
    },
    {
      ...
      $handleStateReadyForQuery:
        function CrossDomainMessager$HandleStateReadyForQuery(source) {
          var queue =
            this.$commandReturnAfterStateReadyQueues[source.get_hostId()];
      ...
      $handleCrossDomainMessage:
        function CrossDomainMessager$HandleCrossDomainMessage(e) {
      ...
      $handleCrossDomainResponse:
        function CrossDomainMessager$HandleCrossDomainResponse(command) {
      ...
      $findHostIdByDomComparison:
        function CrossDomainMessager$FindHostIdByDomComparison(messageEvent) {
  ...
  var $tab_FilterCommandsBuilder = (global.tab.FilterCommandsBuilder =
    ss.mkType($asm, "tab.FilterCommandsBuilder", function () {}, {
      buildApplyFiltersCommandParams:
        function FilterCommandsBuilder$BuildApplyFiltersCommandParams(
          fieldName,
          values,
          updateType,
          options
      ...
      buildRangeFilterCommandParams:
        function FilterCommandsBuilder$BuildRangeFilterCommandParams(
          fieldName,
          filterOptions
        ) {
          if ($tab__Utility.isNullOrEmpty(fieldName)) {
          ...
          if (ss.isValue(filterOptions.min)) {
            if ($tab__Utility.isDate(filterOptions.min)) {
              ...
              if ($tab__Utility.isDateValid(dt)) {
                commandParameters["api.filterRangeMin"] =
          ...
          if (ss.isValue(filterOptions.max)) {
            if ($tab__Utility.isDate(filterOptions.max)) {
              ...
              if ($tab__Utility.isDateValid(dt1)) {
                commandParameters["api.filterRangeMax"] =
      ...
      buildRelativeDateFilterCommandParams:
        function FilterCommandsBuilder$BuildRelativeDateFilterCommandParams(
          fieldName,
          filterOptions
        ) {
          if ($tab__Utility.isNullOrEmpty(fieldName)) {
          ...
          if (ss.isValue(filterOptions)) {
            ...
            if (ss.isValue(filterOptions.anchorDate)) {
              commandParameters["api.filterDateArchorValue"] =
                $tab__Utility.serializeDateForServer(filterOptions.anchorDate);
            }
          }
          return commandParameters;
        },
      buildHierarchicalFilterCommandParams:
        function FilterCommandsBuilder$BuildHierarchicalFilterCommandParams(
          fieldName,
          values,
          updateType,
          options
          ...
          if (ss.isValue(fieldValues)) {
            commandParameters["api.filterHierarchicalValues"] =
              JSON.stringify(fieldValues);
          }
          if (ss.isValue(levelValues)) {
            commandParameters["api.filterHierarchicalLevels"] =
              JSON.stringify(levelValues);
          }
          return commandParameters;
        },
      buildClearFilterCommandsParam:
        function FilterCommandsBuilder$BuildClearFilterCommandsParam(
          fieldName
        ) {
          if ($tab__Utility.isNullOrEmpty(fieldName)) {
            throw $tab__TableauException.createNullOrEmptyParameter(
      ...
      normalizeRangeFilterOption:
        function FilterCommandsBuilder$NormalizeRangeFilterOption(
          filterOptions
        ) {
          if (ss.isNullOrUndefined(filterOptions)) {
            throw $tab__TableauException.createNullOrEmptyParameter(
          ...
          if (
            ...
            ss.isNullOrUndefined(filterOptions.nullOption)
          ) {
            throw $tab__TableauException.create(
              "invalidParameter",
      ...
      normalizeRelativeDateFilterOptions:
        function FilterCommandsBuilder$NormalizeRelativeDateFilterOptions(
          filterOptions
        ) {
          if (ss.isNullOrUndefined(filterOptions)) {
            throw $tab__TableauException.createNullOrEmptyParameter(
      ...
      createFilterCommandReturnHandler:
        function FilterCommandsBuilder$CreateFilterCommandReturnHandler(
          commandName,
          fieldName,
          deferred
        ) {
  ...
  var $tab_GetDataCommandsBuilder = (global.tab.GetDataCommandsBuilder =
    ss.mkType($asm, "tab.GetDataCommandsBuilder", function () {}, {
      getSummaryDataCommandParams:
        function GetDataCommandsBuilder$GetSummaryDataCommandParams(options) {
          var commandParameters = {};
      ...
      getUnderlyingDataCommandParams:
        function GetDataCommandsBuilder$GetUnderlyingDataCommandParams(
          options
        ) {
          var commandParameters = {};
          options = options || new Object();
      ...
      getUnderlyingTablesCommandParams:
        function GetDataCommandsBuilder$GetUnderlyingTablesCommandParams() {
          return {};
        },
      getUnderlyingTableDataCommandParams:
        function GetDataCommandsBuilder$GetUnderlyingTableDataCommandParams(
          tableId,
          options
        ) {
          var commandParameters = {};
      ...
      getSummaryDataResponseHandler:
        function GetDataCommandsBuilder$GetSummaryDataResponseHandler(
          deferred
        ) {
          return new (ss.makeGenericType($tab_CommandReturnHandler$1, [
            Object,
      ...
      getUnderlyingDataResponseHandler:
        function GetDataCommandsBuilder$GetUnderlyingDataResponseHandler(
          deferred
        ) {
          return new (ss.makeGenericType($tab_CommandReturnHandler$1, [
            Object,
      ...
      processGetDataPresModel:
        function GetDataCommandsBuilder$ProcessGetDataPresModel(model) {
      ...
      $processUnderlyingTable:
        function GetDataCommandsBuilder$ProcessUnderlyingTable(apiTable) {
          var clientTable = [];
      ...
      $processUnderlyingColumns:
        function GetDataCommandsBuilder$ProcessUnderlyingColumns(apiColumns) {
          var clientColumns = [];
      ...
      $appendErrorMessageIfNeededThenLog:
        function GetDataCommandsBuilder$AppendErrorMessageIfNeededThenLog(
          remoteError,
          message
        ) {
      ...
      getUnderlyingTablesResponseHandler:
        function GetDataCommandsBuilder$GetUnderlyingTablesResponseHandler(
          deferred
        ) {
          return new (ss.makeGenericType($tab_CommandReturnHandler$1, [
            Object,
            ...
            ss.mkdel(this, function (result) {
              ...
              var logicalTables =
                this.$processGetLogicalTablesPresModel(tablesResult);
              deferred.resolve(logicalTables._toApiCollection());
            }),
            ss.mkdel(this, function (remoteError, message) {
              deferred.reject(
                $tab__TableauException.createServerError(
                  this.$appendErrorMessageIfNeededThenLog(remoteError, message)
                )
              );
            })
          );
        },
      $processGetLogicalTablesPresModel:
        function GetDataCommandsBuilder$ProcessGetLogicalTablesPresModel(
          model
        ) {
          ...
          for (var $t1 = 0; $t1 < model.logicalTables.length; $t1++) {
            ...
            logicalTables._add(
              pm.tableId,
              new $tableauSoftware_LogicalTable(pm.tableId, pm.caption)
            );
          }
          return logicalTables;
        },
      getUnderlyingTableDataResponseHandler:
        function GetDataCommandsBuilder$GetUnderlyingTableDataResponseHandler(
          deferred
        ) {
          return new (ss.makeGenericType($tab_CommandReturnHandler$1, [
            Object,
  ...
  var $tab_HostedApiMessageHandler = (global.tab.HostedApiMessageHandler =
    ss.mkType(
      $asm,
      ...
      {
        add_stateReadyForQuery:
          function HostedApiMessageHandler$add_StateReadyForQuery(value) {
        ...
        remove_stateReadyForQuery:
          function HostedApiMessageHandler$remove_StateReadyForQuery(value) {
  ...
  var $tab_HostedApiMessageRouter = (global.tab.HostedApiMessageRouter =
    ss.mkType(
      $asm,
  ...
  var $tableauSoftware_DataTable = (global.tableauSoftware.DataTable =
    ss.mkType(
      $asm,
      "tableauSoftware.DataTable",
      function (impl) {
  ...
  var $tableauSoftware_LogicalTable = (global.tableauSoftware.LogicalTable =
    ss.mkType(
      $asm,
      "tableauSoftware.LogicalTable",
      function (tableId, caption) {
        this.$tableId = null;
        this.$caption = null;
...
(function () {
  ...
  var $tab__CustomViewImpl = (global.tab._CustomViewImpl = ss.mkType(
    $asm,
    "tab._CustomViewImpl",
    ...
    },
    {
      ...
      saveAsync: function CustomViewImpl$SaveAsync() {
        ...
        // send the command
        var returnHandler =
          $tab__CustomViewImpl.$createCustomViewCommandReturnHandler(
    ...
    },
    {
      ...
      _makeCurrentCustomViewDefaultAsync:
        function CustomViewImpl$MakeCurrentCustomViewDefaultAsync(
          workbookImpl,
          messagingOptions
        ) {
          var deferred = new tab._Deferred();
      ...
      buildCustomViewKeyForDuplicate:
        function CustomViewImpl$BuildCustomViewKeyForDuplicate(
          customViewName,
          userName
        ) {
      ...
      $processOneCustomViewUpdate:
        function CustomViewImpl$ProcessOneCustomViewUpdate(
          workbookImpl,
          messagingOptions,
          customViewsInfo,
          customView,
          ...
          if (workbookImpl.get_$customViews()._has(customViewKey)) {
            customViewKey = $tab__CustomViewImpl.buildCustomViewKeyForDuplicate(
              customViewImpl.get_$name(),
              customView.owner.username
            );
          }
          workbookImpl
            .get_$customViews()
      ...
      $createCustomViewCommandReturnHandler:
        function CustomViewImpl$CreateCustomViewCommandReturnHandler(
          commandName,
          deferred,
          successCallback
        ) {
  ...
  var $tab__DashboardImpl = (global.tab._DashboardImpl = ss.mkType(
    ...
    },
    {
            ...
            try {
              while ($t1.moveNext()) {
                ...
                for (var i = 0; i < this.get_worksheets().get__length(); i++) {
                  if (
                    ss.referenceEquals(
                      this.get_worksheets().get_item(i)._impl.get_name(),
                      sheetName
                    )
                  ) {
                    var $t2 = new Object();
                    $t2.filters = Array.prototype.slice.call(
                      result.filters[sheetName]
                    );
                    var worksheetFiltersPM = $t2;
                    var worksheetFilters =
                      $tableauSoftware_Filter.processFiltersList(
                        this.get_worksheets().get_item(i)._impl,
                        worksheetFiltersPM
                      );
                    filters = filters.concat(
                      worksheetFilters._toApiCollection()
                    );
                  }
                }
              }
      ...
      $applyFilterAsync: function DashboardImpl$ApplyFilterAsync(
        fieldName,
        values,
        updateType,
        options
        ...
        var commandParameters =
          this.$filterCommandsBuilder.buildApplyFiltersCommandParams(
            fieldName,
            values,
            updateType,
            options
        ...
        var deferred = new tab._Deferred();
        var returnHandler =
          this.$filterCommandsBuilder.createFilterCommandReturnHandler(
      ...
      $verifyActiveDashboard: function DashboardImpl$VerifyActiveDashboard() {
        ...
        var isWithinActiveStoryPoint =
          ...
          this.get_parentStoryPointImpl().get_parentStoryImpl().get_isActive();
  ...
  var $tab__DataSourceImpl = (global.tab._DataSourceImpl = ss.mkType(
    ...
    },
    {
      ...
      processDataSourcesForWorksheet:
        function DataSourceImpl$ProcessDataSourcesForWorksheet(pm) {
          ...
          for (var $t1 = 0; $t1 < pm.dataSources.length; $t1++) {
            ...
            var dataSourceImpl =
              $tab__DataSourceImpl.processDataSource(dataSourcePm);
  ...
  var $tab__StoryImpl = (global.tab._StoryImpl = ss.mkType(
    ...
    },
    {
      ...
      remove_activeStoryPointChange:
        function StoryImpl$remove_ActiveStoryPointChange(value) {
      ...
      $activatePreviousNextStoryPointAsync:
        function StoryImpl$ActivatePreviousNextStoryPointAsync(commandName) {
      ...
      $updateActiveState: function StoryImpl$UpdateActiveState(
        ...
        var oldStoryPointInfo =
          this.$storyPointsInfo[previouslyActiveStoryPointImpl.get_index()];
      ...
      $raiseActiveStoryPointChange:
        function StoryImpl$RaiseActiveStoryPointChange(
          oldStoryPointInfo,
          newStoryPoint
        ) {
  ...
  var $tab__VizManagerImpl = ss.mkType(
    ...
    null,
    {
      ...
      $verifyVizNotAlreadyParented:
        function VizManagerImpl$VerifyVizNotAlreadyParented(viz) {
        ...
        try {
          while ($t1.moveNext()) {
            ...
            if (
              ...
              entry.key !== "disableUrlActionsPopups"
            ) {
              url.push("&");
  ...
  var $tab__WorkbookImpl = (global.tab._WorkbookImpl = ss.mkType(
    ...
    },
    {
      ...
      $findActiveSheetOrSheetWithinActiveDashboard:
        function WorkbookImpl$FindActiveSheetOrSheetWithinActiveDashboard(
          sheetOrInfoOrName
        ) {
          ...
          var sheetName =
            $tab__WorkbookImpl.$extractSheetName(sheetOrInfoOrName);
      ...
      $activateSheetWithInfoAsync:
        function WorkbookImpl$ActivateSheetWithInfoAsync(sheetInfoImpl) {
          return this.$activateSheetInternalAsync(
            sheetInfoImpl.name,
            sheetInfoImpl.url
          );
        },
      $activateSheetInternalAsync:
        function WorkbookImpl$ActivateSheetInternalAsync(sheetName, sheetUrl) {
          var deferred = new tab._Deferred();
      ...
      $initializeActiveSheet: function WorkbookImpl$InitializeActiveSheet(
        ...
        var newActiveSheetInfo =
          this.$publishedSheetsInfo._get(currentSheetName);
        if (
        ...
        if (
          ss.isValue(this.$activeSheetImpl) &&
          ss.referenceEquals(this.$activeSheetImpl.get_name(), currentSheetName)
        ) {
          return;
        }
      ...
      $setActiveCustomViewAsDefaultAsync:
        function WorkbookImpl$SetActiveCustomViewAsDefaultAsync() {
          return $tab__CustomViewImpl._makeCurrentCustomViewDefaultAsync(
            this,
            this.$messagingOptions
          );
        },
      get_$lastChangedParameterImpl:
        function WorkbookImpl$get_LastChangedParameterImpl() {
          return this.$lastChangedParameterImpl;
        },
      set_$lastChangedParameterImpl:
        function WorkbookImpl$set_LastChangedParameterImpl(value) {
      ...
      $changeParameterValueAsync:
        function WorkbookImpl$ChangeParameterValueAsync(parameterName, value) {
          var deferred = new tab._Deferred();
    ...
    },
    {
      ...
      $findAndCreateParameterImpl:
        function WorkbookImpl$FindAndCreateParameterImpl(
          parameterName,
          paramList
        ) {
          for (var $t1 = 0; $t1 < paramList.parameters.length; $t1++) {
  ...
  var $tab__WorksheetImpl = (global.tab._WorksheetImpl = ss.mkType(
    ...
    {
      $appendContextMenuAsync: function WorksheetImpl$AppendContextMenuAsync(
        sheetName,
        targetMenu,
        config
      ) {
      ...
      $removeContextMenuAsync: function WorksheetImpl$RemoveContextMenuAsync(
        sheetName,
        targetMenu,
        menuItemId
      ) {
      ...
      $executeContextMenuAsync: function WorksheetImpl$ExecuteContextMenuAsync(
        sheetName,
        targetMenu,
        menuItemId
      ) {
      ...
      get_parentDashboardImpl:
        function WorksheetImpl$get_ParentDashboardImpl() {
      ...
      $getDataSourcesAsync: function WorksheetImpl$GetDataSourcesAsync() {
        ...
        var returnHandler = new (ss.makeGenericType(
          ...
          function (result) {
            var dataSources =
              $tab__DataSourceImpl.processDataSourcesForWorksheet(result);
      ...
      $verifyActiveSheetOrEmbeddedInActiveDashboard:
        function WorksheetImpl$VerifyActiveSheetOrEmbeddedInActiveDashboard() {
      ...
      $getFilterAsync: function WorksheetImpl$GetFilterAsync(
        ...
        commandParameters["api.filterRelevantValuesOnly"] =
          ss.isNullOrUndefined(options.relevantValuesOnly)
            ? true
            : options.relevantValuesOnly;
        // send the command
        var returnHandler = new (ss.makeGenericType(
          tab.CommandReturnHandler$1,
          [Object]
      ...
      $getAppliedWorksheetsAsync:
        function WorksheetImpl$GetAppliedWorksheetsAsync(
          worksheetName,
          filterFieldName
        ) {
          var deferred = new tab._Deferred();
          var successCallback = function successCallback(result) {
            ...
            if (ss.isValue(pm.sharedFilterWorksheetInfoList)) {
              for (
                var $t1 = 0;
                $t1 < pm.sharedFilterWorksheetInfoList.length;
                $t1++
              ) {
      ...
      $setAppliedWorksheetsAsync:
        function WorksheetImpl$SetAppliedWorksheetsAsync(
          applyToWorksheets,
          currentWorksheet,
          filterFieldName,
          filterFieldCaption
          ...
          var getAppliedWorksheetsSuccessCallback = ss.mkdel(
            this,
            function (result) {
              var pm = result;
              ...
              for (var $t2 = 0; $t2 < applyToWorksheets.length; $t2++) {
                ...
                if (
                  !ss.contains(selectedWorksheets, sheet) &&
                  !ss.contains(nonSelectedWorksheets, sheet)
                ) {
                  var message1 =
                    "The field " +
                    filterFieldCaption +
                    ...
                    sheet;
                  deferred.reject(
                    tab._TableauException.createInternalError(message1)
                  );
                  return;
                }
              }
              ...
              var setAppliedWorksheetSuccessCallback =
                function setAppliedWorksheetSuccessCallback(
                  setAppliedWorksheetResult
                ) {
                  deferred.resolve(applyToWorksheets);
                };
              var setAppliedWorksheetErrorCallback =
                function setAppliedWorksheetErrorCallback(
                  remoteError,
                  message2
                ) {
                  deferred.reject(
                    tab._TableauException.createServerError(message2)
                  );
                };
              var returnHandler = new (ss.makeGenericType(
                tab.CommandReturnHandler$1,
                ...
                0,
                setAppliedWorksheetSuccessCallback,
                setAppliedWorksheetErrorCallback
              );
          ...
          var getAppliedWorksheetsErrorCallback =
            function getAppliedWorksheetsErrorCallback(remoteError1, message3) {
              deferred.reject(
                tab._TableauException.createServerError(message3)
              );
            };
          ...
          this.$getSharedFilterWorksheets(Array).call(
            ...
            currentWorksheet,
            filterFieldName,
            getAppliedWorksheetsSuccessCallback,
            getAppliedWorksheetsErrorCallback
          );
          return deferred.get_promise();
        },
      $getDistinctWorksheets: function WorksheetImpl$GetDistinctWorksheets(
        applyToWorksheets
      ) {
        var check = new Set();
        var result = [];
      ...
      $getSharedFilterWorksheets: function $getSharedFilterWorksheets(T) {
        return function WorksheetImpl$GetSharedFilterWorksheets(
          worksheetName,
          filterFieldName,
          successCallback,
          errorCallback
          ...
          var returnHandler = new (ss.makeGenericType(
            ...
            "api.GetAppliedWorksheetsCommand",
            0,
            successCallback,
            errorCallback
          );
      ...
      $applyRangeFilterAsync: function WorksheetImpl$ApplyRangeFilterAsync(
        ...
        var fixedUpFilterOptions =
          this.$filterCommandsBuilder.normalizeRangeFilterOption(options);
      ...
      $applyRelativeDateFilterAsync:
        function WorksheetImpl$ApplyRelativeDateFilterAsync(
          fieldName,
          options
        ) {
          var fixedUpFilterOptions =
            this.$filterCommandsBuilder.normalizeRelativeDateFilterOptions(
              options
            );
      ...
      $applyHierarchicalFilterAsync:
        function WorksheetImpl$ApplyHierarchicalFilterAsync(
          fieldName,
          values,
          updateType,
          options
      ...
      $clearFilterInternalAsync:
        function WorksheetImpl$ClearFilterInternalAsync(fieldName) {
          this.$verifyActiveSheetOrEmbeddedInActiveDashboard();
          var deferred = new tab._Deferred();
          var commandParameters =
            this.$filterCommandsBuilder.buildClearFilterCommandsParam(
              fieldName
            );
          this.$addVisualIdToCommand(commandParameters);
          // Send the command
      ...
      $applyFilterWithValuesInternalAsync:
        function WorksheetImpl$ApplyFilterWithValuesInternalAsync(
          fieldName,
          values,
          updateType,
          options
      ...
      $applyRangeFilterInternalAsync:
        function WorksheetImpl$ApplyRangeFilterInternalAsync(
          fieldName,
          filterOptions
        ) {
          this.$verifyActiveSheetOrEmbeddedInActiveDashboard();
          var commandParameters =
            this.$filterCommandsBuilder.buildRangeFilterCommandParams(
              fieldName,
              filterOptions
            );
          this.$addVisualIdToCommand(commandParameters);
      ...
      $applyRelativeDateFilterInternalAsync:
        function WorksheetImpl$ApplyRelativeDateFilterInternalAsync(
          fieldName,
          filterOptions
        ) {
          this.$verifyActiveSheetOrEmbeddedInActiveDashboard();
          var commandParameters =
            this.$filterCommandsBuilder.buildRelativeDateFilterCommandParams(
              fieldName,
              filterOptions
            );
          this.$addVisualIdToCommand(commandParameters);
      ...
      $applyHierarchicalFilterInternalAsync:
        function WorksheetImpl$ApplyHierarchicalFilterInternalAsync(
          fieldName,
          values,
          updateType,
          options
          ...
          this.$verifyActiveSheetOrEmbeddedInActiveDashboard();
          var commandParameters =
            this.$filterCommandsBuilder.buildHierarchicalFilterCommandParams(
              fieldName,
              values,
              updateType,
              options
      ...
      $clearSelectedMarksAsync:
        function WorksheetImpl$ClearSelectedMarksAsync() {
          this.$verifyActiveSheetOrEmbeddedInActiveDashboard();
          var deferred = new tab._Deferred();
          var commandParameters = {};
          this.$addVisualIdToCommand(commandParameters);
      ...
      $selectMarksWithFieldNameAndValueAsync:
        function WorksheetImpl$SelectMarksWithFieldNameAndValueAsync(
          fieldName,
          value,
          updateType
        ) {
      ...
      $selectMarksWithMultiDimOptionAsync:
        function WorksheetImpl$SelectMarksWithMultiDimOptionAsync(
          fieldValuesMap,
          updateType
        ) {
      ...
      $selectMarksWithMarksArrayAsync:
        function WorksheetImpl$SelectMarksWithMarksArrayAsync(
          marksArray,
          updateType
        ) {
          var catNameList = [];
      ...
      $selectMarksWithValuesAsync:
        function WorksheetImpl$SelectMarksWithValuesAsync(
          tupleIdList,
          catNameList,
          catValueList,
          hierNameList,
          ...
          var returnHandler = new (ss.makeGenericType(
            ...
            function (result) {
              var error =
                $tab__WorksheetImpl.$createSelectionCommandError(result);
              if (ss.isNullOrUndefined(error)) {
      ...
      $getSummaryDataAsync: function WorksheetImpl$GetSummaryDataAsync(
        ...
        //Prepare the command parameters
        var commandParameters =
          this.$getDataCommandsBuilder.getSummaryDataCommandParams(options);
        this.$addVisualIdToCommand(commandParameters);
        var returnHandler =
          this.$getDataCommandsBuilder.getSummaryDataResponseHandler(deferred);
        this.sendCommand(Object).call(this, commandParameters, returnHandler);
        return deferred.get_promise();
      },
      $getUnderlyingDataAsync: function WorksheetImpl$GetUnderlyingDataAsync(
        ...
        //Prepare the command parameters
        var commandParameters =
          this.$getDataCommandsBuilder.getUnderlyingDataCommandParams(options);
        this.$addVisualIdToCommand(commandParameters);
        var returnHandler =
          this.$getDataCommandsBuilder.getUnderlyingDataResponseHandler(
            deferred
          );
        this.sendCommand(Object).call(this, commandParameters, returnHandler);
        return deferred.get_promise();
      ...
      $getUnderlyingTablesAsync:
        function WorksheetImpl$GetUnderlyingTablesAsync() {
          this.$verifyActiveSheetOrEmbeddedInActiveDashboard();
          var deferred = new tab._Deferred();
          // Prepare the command parameters
          var commandParameters =
            this.$getDataCommandsBuilder.getUnderlyingTablesCommandParams();
          this.$addVisualIdToCommand(commandParameters);
          var returnHandler =
            this.$getDataCommandsBuilder.getUnderlyingTablesResponseHandler(
              deferred
            );
          this.sendCommand(Object).call(this, commandParameters, returnHandler);
          return deferred.get_promise();
      ...
      $getUnderlyingTableDataAsync:
        function WorksheetImpl$GetUnderlyingTableDataAsync(tableId, options) {
          this.$verifyActiveSheetOrEmbeddedInActiveDashboard();
          var deferred = new tab._Deferred();
          //Prepare the command parameters
          var commandParameters =
            this.$getDataCommandsBuilder.getUnderlyingTableDataCommandParams(
              tableId,
              options
            );
          this.$addVisualIdToCommand(commandParameters);
          var returnHandler =
            this.$getDataCommandsBuilder.getUnderlyingTableDataResponseHandler(
              deferred
            );
          this.sendCommand(Object).call(this, commandParameters, returnHandler);
          return deferred.get_promise();
        },
      $clearHighlightedMarksAsync:
        function WorksheetImpl$ClearHighlightedMarksAsync() {
          this.$verifyActiveSheetOrEmbeddedInActiveDashboard();
          var deferred = new tab._Deferred();
          var commandParameters = {};
          this.$addVisualIdToCommand(commandParameters);
      ...
      $highlightMarksByPatternMatchAsync:
        function WorksheetImpl$HighlightMarksByPatternMatchAsync(
          fieldName,
          patternMatch
        ) {
          tab._Param.verifyString(fieldName, "fieldName");
      ...
      $getHighlightedMarksAsync:
        function WorksheetImpl$GetHighlightedMarksAsync() {
          this.$verifyActiveSheetOrEmbeddedInActiveDashboard();
          // prepare the command parameters
          var deferred = new tab._Deferred();
          var commandParameters = {};
    ...
    },
    {
      ...
      $createSelectionCommandError:
        function WorksheetImpl$CreateSelectionCommandError(rawPm) {
          var commandError = rawPm;
          if (ss.isValue(commandError) && ss.isValue(commandError.errorCode)) {
            var additionalInfo = ss.isValue(commandError.additionalInformation)
              ? commandError.additionalInformation.toString()
  ...
  var $tab_$CustomViewEventContext = ss.mkType(
    ...
    {
      get__customViewImpl:
        function CustomViewEventContext$get_CustomViewImpl() {
  ...
  var $tab_$ParameterImpl = ss.mkType(
    ...
    function (pm) {
      ...
      this.$allowableValuesType =
        tab.ApiEnumConverter.convertParameterAllowableValuesType(
    ...
    },
    {
      ...
      get_$allowableValuesType:
        function ParameterImpl$get_AllowableValuesType() {
  ...
  var $tab_CustomMarkContextMenuEvent = (global.tab.CustomMarkContextMenuEvent =
    ss.mkType(
      $asm,
      "tab.CustomMarkContextMenuEvent",
      function (eventName, viz, contextMenuId, worksheetImpl) {
      ...
      {
        getContextMenuId:
          function CustomMarkContextMenuEvent$GetContextMenuId() {
            return this.$contextMenuId;
          },
        getSelectedMarksAsync:
          function CustomMarkContextMenuEvent$GetSelectedMarksAsync() {
  ...
  var $tab_FirstVizSizeKnownEvent = (global.tab.FirstVizSizeKnownEvent =
    ss.mkType(
      $asm,
  ...
  var $tab_HighlightEvent = (global.tab.HighlightEvent = ss.mkType(
    ...
    {
      getHighlightedMarksAsync:
        function HighlightEvent$GetHighlightedMarksAsync() {
  ...
  var $tab_JsApiMessageRouter = (global.tab.JsApiMessageRouter = ss.mkType(
    ...
    },
    {
      ...
      sendCommand: function sendCommand(T) {
        return function JsApiMessageRouter$SendCommand(
          ...
          if (returnHandler.get_commandName() === "api.ShowCustomViewCommand") {
            var customViewCallbacks =
              this.$customViewLoadCallbacks[source.get_hostId()];
      ...
      $handleCustomViewsListLoad:
        function JsApiMessageRouter$HandleCustomViewsListLoad(source) {
          var handlerId = source.get_hostId();
      ...
      $handleLegacyNotifications:
        function JsApiMessageRouter$HandleLegacyNotifications(
          command,
          handler
        ) {
  ...
  var $tab_JsApiMessagingOptions = (global.tab.JsApiMessagingOptions =
    ss.mkType(
      $asm,
  ...
  var $tab_StoryPointInfoImplUtil = (global.tab.StoryPointInfoImplUtil =
    ss.mkType($asm, "tab.StoryPointInfoImplUtil", null, null, {
  ...
  var $tab_StoryPointSwitchEvent = (global.tab.StoryPointSwitchEvent =
    ss.mkType(
      $asm,
      ...
      },
      {
        getOldStoryPointInfo:
          function StoryPointSwitchEvent$GetOldStoryPointInfo() {
  ...
  var $tab_UrlActionEvent = (global.tab.UrlActionEvent = ss.mkType(
    $asm,
    "tab.UrlActionEvent",
    function (eventName, viz, url, target) {
      this.$url = null;
      this.$target = null;
      $tab_TableauEvent.call(this, eventName, viz);
      this.$url = url;
  ...
  var $tab_VizImpl = (global.tab.VizImpl = ss.mkType(
    ...
    },
    {
      ...
      remove_$parameterValueChange:
        function VizImpl$remove_ParameterValueChange(value) {
      ...
      remove_$customViewSetDefault:
        function VizImpl$remove_CustomViewSetDefault(value) {
      ...
      add_$urlAction: function VizImpl$add_UrlAction(value) {
        this.$1$UrlActionField = ss.delegateCombine(
          this.$1$UrlActionField,
          value
        );
      },
      remove_$urlAction: function VizImpl$remove_UrlAction(value) {
        this.$1$UrlActionField = ss.delegateRemove(
          this.$1$UrlActionField,
          value
        );
      },
      add_$customMarkContextMenu: function VizImpl$add_CustomMarkContextMenu(
        value
      ) {
        this.$1$CustomMarkContextMenuField = ss.delegateCombine(
          this.$1$CustomMarkContextMenuField,
          value
        );
      },
      remove_$customMarkContextMenu:
        function VizImpl$remove_CustomMarkContextMenu(value) {
          this.$1$CustomMarkContextMenuField = ss.delegateRemove(
            this.$1$CustomMarkContextMenuField,
            value
          );
        },
      ...
      get_$areAutomaticUpdatesPaused:
        function VizImpl$get_AreAutomaticUpdatesPaused() {
      ...
      handleEventNotification: function VizImpl$HandleEventNotification(
        ...
        var notification =
          tab._ApiServerNotification.deserialize(eventParameters);
        switch (eventName) {
      ...
      $showExportDataDialog: function VizImpl$ShowExportDataDialog(
        ...
        var sheetName =
          this.$verifyOperationAllowedOnActiveSheetOrSheetWithinActiveDashboard(
            sheetOrInfoOrName
          );
      ...
      $showExportPowerPointDialog:
        function VizImpl$ShowExportPowerPointDialog() {
          this.$invokeCommand("showExportPowerPointDialog");
        },
      $exportCrossTabToExcel: function VizImpl$ExportCrossTabToExcel(
        sheetOrInfoOrName
      ) {
        var sheetName =
          this.$verifyOperationAllowedOnActiveSheetOrSheetWithinActiveDashboard(
      ...
      $showDownloadWorkbookDialog:
        function VizImpl$ShowDownloadWorkbookDialog() {
      ...
      $setAreAutomaticUpdatesPaused:
        function VizImpl$SetAreAutomaticUpdatesPaused(value) {
      ...
      $enableVisibleRectCommunication:
        function VizImpl$EnableVisibleRectCommunication() {
          if (
            !tab._Utility.hasWindowPostMessage() ||
            ss.isNullOrUndefined(this.$iframe) ||
            !ss.isValue(this.$iframe.contentWindow)
      ...
      $raiseCustomMarkContextMenuEvent:
        function VizImpl$RaiseCustomMarkContextMenuEvent(notification) {
          if (!ss.staticEquals(this.$1$CustomMarkContextMenuField, null)) {
            ...
            if (ss.isValue(worksheetImpl)) {
              ...
              this.$1$CustomMarkContextMenuField(
                new $tab_CustomMarkContextMenuEvent(
                  "custommarkcontextmenu",
                  this.$viz,
                  notification.get_data().toString(),
                  worksheetImpl
                )
              );
            }
      ...
      $raiseUrlAction: function VizImpl$RaiseUrlAction(url, target) {
        if (!ss.staticEquals(this.$1$UrlActionField, null)) {
          this.$1$UrlActionField(
            new $tab_UrlActionEvent("urlaction", this.$viz, url, target)
          );
        }
      },
      ...
      $verifyOperationAllowedOnActiveSheetOrSheetWithinActiveDashboard:
        function VizImpl$VerifyOperationAllowedOnActiveSheetOrSheetWithinActiveDashboard(
          sheetOrInfoOrName
        ) {
          ...
          var sheetImpl =
            this.$workbookImpl.$findActiveSheetOrSheetWithinActiveDashboard(
              sheetOrInfoOrName
            );
      ...
      $invokeAutomaticUpdatesCommandAsync:
        function VizImpl$InvokeAutomaticUpdatesCommandAsync(command) {
          if (
      ...
      $invokeCommand: function VizImpl$InvokeCommand(command, sheetName) {
        if (
          ...
          command !== "showExportPowerPointDialog" &&
          command !== "exportCrosstabToExcel" &&
      ...
      $handleFirstVizSizeKnownEvent:
        function VizImpl$HandleFirstVizSizeKnownEvent(notification) {
      ...
      $handleMarksSelectionChangedEvent:
        function VizImpl$HandleMarksSelectionChangedEvent(notification) {
      ...
      $handleMarksHighlightChangedEvent:
        function VizImpl$HandleMarksHighlightChangedEvent(notification) {
          // Don't raise an event if nobody is listening or if the workbook doesn't match.
          if (
      ...
      $handleParameterChangedEvent:
        function VizImpl$HandleParameterChangedEvent(notification) {
      ...
      $handleCustomViewsListLoadedEvent:
        function VizImpl$HandleCustomViewsListLoadedEvent(notification) {
      ...
      $handleCustomViewUpdatedEvent:
        function VizImpl$HandleCustomViewUpdatedEvent(notification) {
          var info = JSON.parse(ss.cast(notification.get_data(), String));
          // Create the workbook if does not exist
          if (ss.isNullOrUndefined(this.$workbookImpl)) {
            this.$workbookImpl = new $tab__WorkbookImpl(
      ...
      $handleCustomViewRemovedEvent:
        function VizImpl$HandleCustomViewRemovedEvent() {
      ...
      $handleCustomViewSetDefaultEvent:
        function VizImpl$HandleCustomViewSetDefaultEvent(notification) {
          var info = JSON.parse(ss.cast(notification.get_data(), String));
          if (ss.isValue(this.$workbookImpl)) {
            $tab__CustomViewImpl._processCustomViews(
              this.$workbookImpl,
      ...
      $handleToolbarStateChangeEvent:
        function VizImpl$HandleToolbarStateChangeEvent(notification) {
      ...
      $handleStorytellingStateChangedEvent:
        function VizImpl$HandleStorytellingStateChangedEvent(notification) {
      ...
      $handleUrlActionEvent: function VizImpl$HandleUrlActionEvent(
        notification
      ) {
        if (!ss.staticEquals(this.$1$UrlActionField, null)) {
      ...
      $handleCustomMarkContextMenuEvent:
        function VizImpl$HandleCustomMarkContextMenuEvent(notification) {
      ...
      $ensureCalledAfterFirstInteractive:
        function VizImpl$EnsureCalledAfterFirstInteractive(action) {
          var start = new Date();
          var poll = null;
      ...
      $createStaticImageElement: function VizImpl$CreateStaticImageElement(
        ...
        var img = ss.cast(
          $t1,
          ss.isValue($t1) &&
            ss.isInstanceOfType($t1, Element) &&
            $t1.tagName === "DIV"
        );
      ...
      $createIframe: function VizImpl$CreateIframe() {
        ...
        var ifr = ss.cast(
          $t1,
          ss.isValue($t1) &&
            ss.isInstanceOfType($t1, window.Element) &&
            $t1.tagName === "IFRAME"
        );
        ifr.frameBorder = "0";
  ...
  var $tableauSoftware_CategoricalFilter =
    (global.tableauSoftware.CategoricalFilter = ss.mkType(
      $asm,
      "tableauSoftware.CategoricalFilter",
  ...
  var $tableauSoftware_CustomView = (global.tableauSoftware.CustomView =
    ss.mkType(
      $asm,
      "tableauSoftware.CustomView",
  ...
  var $tableauSoftware_Dashboard = (global.tableauSoftware.Dashboard =
    ss.mkType(
      $asm,
      "tableauSoftware.Dashboard",
      ...
      },
      {
        ...
        applyFilterAsync: function Dashboard$ApplyFilterAsync(
          fieldName,
          values,
          updateType,
          options
  ...
  var $tableauSoftware_DashboardObject =
    (global.tableauSoftware.DashboardObject = ss.mkType(
      $asm,
      "tableauSoftware.DashboardObject",
  ...
  var $tableauSoftware_DataSource = (global.tableauSoftware.DataSource =
    ss.mkType(
      $asm,
      "tableauSoftware.DataSource",
      function (impl) {
  ...
  var $tableauSoftware_Filter = (global.tableauSoftware.Filter = ss.mkType(
    ...
    },
    {
      ...
      setAppliedWorksheetsAsync: function Filter$SetAppliedWorksheetsAsync(
        applyToWorksheets
      ) {
  ...
  var $tableauSoftware_HierarchicalFilter =
    (global.tableauSoftware.HierarchicalFilter = ss.mkType(
      $asm,
      "tableauSoftware.HierarchicalFilter",
      function (worksheetImpl, pm) {
        this.$levels = 0;
  ...
  var $tableauSoftware_Parameter = (global.tableauSoftware.Parameter =
    ss.mkType(
      $asm,
      "tableauSoftware.Parameter",
      function (impl) {
  ...
  var $tableauSoftware_QuantitativeFilter =
    (global.tableauSoftware.QuantitativeFilter = ss.mkType(
      $asm,
      "tableauSoftware.QuantitativeFilter",
      function (worksheetImpl, pm) {
        this.$domainMin = null;
      ...
      },
      {
        ...
        getIncludeNullValues:
          function QuantitativeFilter$GetIncludeNullValues() {
  ...
  var $tableauSoftware_RelativeDateFilter =
    (global.tableauSoftware.RelativeDateFilter = ss.mkType(
      $asm,
      "tableauSoftware.RelativeDateFilter",
      function (worksheetImpl, pm) {
  ...
  var $tableauSoftware_SheetInfo = (global.tableauSoftware.SheetInfo =
    ss.mkType(
      $asm,
  ...
  var $tableauSoftware_Story = (global.tableauSoftware.Story = ss.mkType(
    ...
    },
    {
      ...
      activatePreviousStoryPointAsync:
        function Story$ActivatePreviousStoryPointAsync() {
          return this._impl.activatePreviousStoryPointAsync();
        },
      activateNextStoryPointAsync:
        function Story$ActivateNextStoryPointAsync() {
  ...
  var $tableauSoftware_StoryPoint = (global.tableauSoftware.StoryPoint =
    ss.mkType(
      $asm,
      "tableauSoftware.StoryPoint",
      function (impl) {
  ...
  var $tableauSoftware_StoryPointInfo = (global.tableauSoftware.StoryPointInfo =
    ss.mkType(
      $asm,
      "tableauSoftware.StoryPointInfo",
      function (impl) {
  ...
  var $tableauSoftware_ToolbarState = (global.tableauSoftware.ToolbarState =
    ss.mkType(
      $asm,
      "tableauSoftware.ToolbarState",
  ...
  var $tableauSoftware_Viz = (global.tableauSoftware.Viz = ss.mkType(
    ...
    },
    {
      ...
      getAreAutomaticUpdatesPaused:
        function Viz$GetAreAutomaticUpdatesPaused() {
      ...
      exportCrossTabToExcel: function Viz$ExportCrossTabToExcel(
        worksheetWithinDashboard
      ) {
    ...
    },
    {
      ...
      getLastClientInfoResponseMessage:
        function Viz$GetLastClientInfoResponseMessage() {
  ...
  var $tableauSoftware_VizManager = (global.tableauSoftware.VizManager =
    ss.mkType($asm, "tableauSoftware.VizManager", null, null, {
  ...
  var $tableauSoftware_Workbook = (global.tableauSoftware.Workbook = ss.mkType(
    ...
    },
    {
      ...
      setActiveCustomViewAsDefaultAsync:
        function Workbook$SetActiveCustomViewAsDefaultAsync() {
  ...
  var $tableauSoftware_Worksheet = (global.tableauSoftware.Worksheet =
    ss.mkType(
      $asm,
      "tableauSoftware.Worksheet",
      function (impl) {
      ...
      },
      {
        ...
        applyRelativeDateFilterAsync:
          function Worksheet$ApplyRelativeDateFilterAsync(fieldName, options) {
            return this._impl.$applyRelativeDateFilterAsync(fieldName, options);
          },
        applyHierarchicalFilterAsync:
          function Worksheet$ApplyHierarchicalFilterAsync(
            fieldName,
            values,
            updateType,
            options
        ...
        getUnderlyingTablesAsync:
          function Worksheet$GetUnderlyingTablesAsync() {
            return this._impl.$getUnderlyingTablesAsync();
          },
        getUnderlyingTableDataAsync:
          function Worksheet$GetUnderlyingTableDataAsync(tableId, options) {
            return this._impl.$getUnderlyingTableDataAsync(tableId, options);
          },
        clearHighlightedMarksAsync:
          function Worksheet$ClearHighlightedMarksAsync() {
        ...
        highlightMarksByPatternMatchAsync:
          function Worksheet$HighlightMarksByPatternMatchAsync(
            fieldName,
            patternMatch
          ) {
        ...
        getHighlightedMarksAsync:
          function Worksheet$GetHighlightedMarksAsync() {
            return this._impl.$getHighlightedMarksAsync();
          },
        appendContextMenuAsync: function Worksheet$AppendContextMenuAsync(
          targetMenu,
          config
        ) {
          return this._impl.$appendContextMenuAsync(
            this.getName(),
            targetMenu,
            config
          );
        },
        removeContextMenuAsync: function Worksheet$RemoveContextMenuAsync(
          targetMenu,
          menuItemId
        ) {
          return this._impl.$removeContextMenuAsync(
            this.getName(),
            targetMenu,
            menuItemId
          );
        },
        executeContextMenuAsync: function Worksheet$ExecuteContextMenuAsync(
          targetMenu,
          menuItemId
        ) {
          return this._impl.$executeContextMenuAsync(
            this.getName(),
            targetMenu,
            menuItemId
          );
